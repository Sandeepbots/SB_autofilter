...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('🌐 Subscribe YouTube Channel 💗', url=f'')
            ],[
            InlineKeyboardButton('📞 Update Channel ♻️', url=f'')
            ],[
        ...
        for msg in msgs:
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton("🍿 YouTube Channel 🍿", url="")] ] ),
